$(function() {
  ...
  $('.video-wrap').hover(  function() {
    $('.video-wrap').not(this).addClass('fade');
    $( this ).addClass( "hover" );
  }, function() {
    $( this ).removeClass( "hover" );
    $('.video-wrap').removeClass('fade');
  });
  ...
  track = { name: $('#formname').val(), email: $('#formemail').val(), message: $('#formmessage').val() }
